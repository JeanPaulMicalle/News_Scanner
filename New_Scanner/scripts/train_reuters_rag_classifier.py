...
def main() -> None:
    ...
    dataset_path = root / "dataset" / "reuters_balanced_test_2000.csv"
    config_path = root / "config_reuters_true_db.yaml"
    base_model_dir = root / "artifacts" / "classification" / "20260319_174042" / "model"
    output_root = root / "artifacts" / "reuters_rag_classification"
